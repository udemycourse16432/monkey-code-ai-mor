...
-- =============================================
CREATE PROCEDURE [dbo].[spGetCartTotalsWholesalePrice]
...
,Price,
case
 when Price<StorePrice and datediff(day,Carts.DateTime,GetDate())<=30 then Price
 else StorePrice
end as PriceForCart
,StorePrice,Format from Inventory
